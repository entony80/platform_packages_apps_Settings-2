...
package net.zephyr.colorpicker.fragment;
...
import net.zephyr.colorpicker.widget.ApplyColorView;
import net.zephyr.colorpicker.widget.ColorPickerView;
import net.zephyr.colorpicker.widget.ColorViewButton;
import net.zephyr.colorpicker.util.ColorPickerHelper;
...
public class ColorPickerFragment extends Fragment implements
    ...
    private static final int PALETTE_ZEPHYR  = 0;
    ...
    private void setUpPaletteColorButtons() {
        ...
        TypedArray colors = mResources.obtainTypedArray(R.array.color_picker_zephyr_palette);
        ...
        for (int i=0; i<3; i++) {
            ...
            int titleResId = R.string.palette_zephyr_title;
